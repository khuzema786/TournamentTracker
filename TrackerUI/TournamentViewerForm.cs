...
namespace TrackerUI
{
	public partial class TournamentViewerForm : Form
	{
		...
		private string IsValidData()
        {
			...
			bool scoreOneValid = double.TryParse(teamOneScoreText.Text, out double teamOneScore);
			bool scoreTwoValid = double.TryParse(teamTwoScoreText.Text, out double teamTwoScore);

			if(!scoreOneValid)
            {
				output = "Score One Value is Invalid Number.";
            }
			else if (!scoreTwoValid)
			{
				output = "Score Two Value is Invalid Number.";
			}
